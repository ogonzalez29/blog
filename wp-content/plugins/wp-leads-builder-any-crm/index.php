...
Description: Sync data from simple Webforms  & contact 7 forms  and WP User data to SalesForce , Zoho CRM , Vtiger CRM  & Sugar CRM.  Embed forms as Posts , Pages & Widgets. 
Version: 1.3.2
...
define('WP_CONST_ULTIMATE_CRM_CPT_NAME', 'WP Leads Builder For CRM');
...
define('WP_CONST_ULTIMATE_CRM_CPT_VERSION', '1.3.2');

...
{
	include_once(WP_CONST_ULTIMATE_CRM_CPT_DIRECTORY.'lib/vtwsclib/Vtiger/Net/HTTP_Client.php');
	include_once(WP_CONST_ULTIMATE_CRM_CPT_DIRECTORY.'lib/vtwsclib/Vtiger/WSVersion.php');

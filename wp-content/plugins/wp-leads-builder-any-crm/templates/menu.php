...
<nav class='navbar navbar-default' role='navigation'>
   <div>
	...
	<li class="<?php if( (sanitize_text_field($_REQUEST['__module']) =='ManageShortcodes' ) &&( ( sanitize_text_field($_REQUEST['__action']) =='view' ) ||( sanitize_text_field($_REQUEST['__action']) =='ManageFields'  )) ){ echo 'activate'; }else { echo 'deactivate'; }?>" >

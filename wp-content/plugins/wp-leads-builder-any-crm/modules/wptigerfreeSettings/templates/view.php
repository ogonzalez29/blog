...
?>
<div><h2 style="margin-left:15px;">VTiger CRM Settings</h2> <br></div>
		...
		<div class="wp-common-crm-content" style="width: 100%;float: left;">
			...
			<table class="settings-table">
				<tr>
					...
					<td colspan="3">
						<input type='text' class='smack-vtiger-settings-text urlfield' name='url' id='smack_host_address' value="<?php echo sanitize_text_field($config['url']) ?>"/>
					</td>
				</tr>
				<tr>
					<td style='width:160px;'>
				...
				<tr>
					<td style='width:160px;' colspan="3">
						<label id="innertext"><div style='float:left;'> Do you want to capture all WP Users as Vtiger Contacts ? </div></label>
					</td>
					<td>

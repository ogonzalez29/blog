...
$content1 .= "<td style='text-align:center; border-top: 1px solid #dddddd;'><span style='color:red;'>$failure</span></td>";
		...
		$content1 .= "<a href='".esc_url( add_query_arg( array( '__module' => 'ManageShortcodes', '__action' => 'ManageFields', 'module' => 'Leads', 'EditShortCode' => 'yes', 'formtype' =>$formtype_key , '__wpnonce' => $Edit_nonce_key ),$edit_url ) )."'> Edit </a>";
                $content1 .= "</td>";
		$content1 .= "</tr>";
		$number++;
	}
...
?>
	...
	<tr>
	<td> <input type = "button" size = "50" class = "button-primary" value ="Create More Forms" id ="advance_option" onclick="jQuery('#mandatory-upgrade').show(); jQuery('#mandatory-upgrade').css('display','inline')"> <span id="mandatory-upgrade" style="color:red; display:none;"> <a href ="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"> Upgrade To Pro </a> </span>
	 </td>
	<tr>
	</table> 

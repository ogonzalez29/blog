...
<form id="smack-zoho-settings-form" action="<?php echo esc_url_raw($_SERVER['REQUEST_URI']); ?>" method="post">
	<h2 style="margin-left:15px;">Zoho CRM Settings</h2> <br>
		...
		<table class="settings-table">
			...
			<tr>
				<td style='width:160px;' colspan="3">
					<label id="innertext"><div style='float:left;'> Do you want to capture all WP Users as Zoho Contacts ? </div></label>
				</td>
				<td>

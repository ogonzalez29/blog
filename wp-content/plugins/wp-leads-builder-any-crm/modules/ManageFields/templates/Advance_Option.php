...
<br>
<br>
<input type="checkbox" value="on" checked=checked onclick="jQuery('#duplicate-upgrade').show(); jQuery('#duplicate-upgrade').css('display','inline')" />	Duplicate Handling <br>
	<span style="padding-left:30px;"><img onclick="jQuery('#duplicate-upgrade').show(); jQuery('#duplicate-upgrade').css('display','inline')" src="<?php echo esc_url(WP_CONST_ULTIMATE_CRM_CPT_DIR)."images/duplicatehandling.png"; ?>"> </span> <span id="duplicate-upgrade" style="color:red; display:none;"> <a href="https://www.smackcoders.com/wp-leads-builder-any-crm-pro.html" target="_blank"> Upgrade To Pro</a> </span>
 </span>
<br/>
<br/>

...
class OEPL_Lead_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) 
	{
		...
		if($captchaSettings == 'Y'){
			...
			//echo "<p class='WidgetLeadFormCaptcha'><label>What is &nbsp;<strong>".$random1." + ".$random2."</strong>&nbsp; ? </label><input type='text' name='captcha' id='captcha' size='3' maxlength='3'/></p>" ;
			...
			echo "<p>
					...
					<input type='text' name='captcha' id='OEPL_CAPTCHA' maxlength='5' class='LeadFormRequired'/>
				  </p>";
		}
...
function WidgetFormJS(){
	echo "<script>
		  	...
		  	var ReqFieldMsg = '".get_option('OEPL_SugarCRMReqFieldsMessage')."';

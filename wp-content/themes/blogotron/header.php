...
<body <?php body_class(); ?>>
	...
	<div id="page-wrapper">
		...
		<?php if ( get_header_image() ) : ?>
			...
			<a href="<?php echo esc_url( 'http://localhost/blog' ); ?>"><img class="header-image" src="<?php header_image(); ?>" width="<?php echo get_custom_header()->width; ?>" height="<?php echo get_custom_header()->height; ?>" alt="<?php bloginfo( 'name' ); ?>" />

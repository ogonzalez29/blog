...
<h1 class="archive-title">
					<?php
						if ( is_day() ) :
							printf( __( 'Daily Archives: %s', 'simplifiedblog' ), get_the_date() );

						elseif ( is_month() ) :
							printf( __( 'Monthly Archives: %s', 'simplifiedblog' ), get_the_date('F Y') );

						elseif ( is_year() ) :
							printf( __( 'Yearly Archives: %s', 'simplifiedblog' ), get_the_date('Y') );

						else :
							_e( 'Archives', 'simplifiedblog' );

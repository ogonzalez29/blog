...
<?php if ( !is_page() ) : ?><span class="s_category"><span class="fa fa-folder-open-o"></span><?php the_category(', '); ?></span><br /><?php endif; ?>
...
<span class="fa fa-comment"></span><span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'simplifiedblog' ), __( '1 Comment', 'simplifiedblog' ), __( '% Comments', 'simplifiedblog' ) ); ?></span></span>
<?php endif; edit_post_link( __( 'Edit', 'simplifiedblog' ), '<span class="s_edit"><span class="fa fa-edit"></span><span class="edit-link">', '</span></span>' ); ?>
</footer>  